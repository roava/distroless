...
http_archive(
    ...
    sha256 = "66518c31ea7735ae5a0bb8ea27edfee846702dbdc708fea6ad4a308d43ef5652",
    strip_prefix = "node-v12.16.3-linux-x64",
    type = "tar.gz",
    urls = ["https://nodejs.org/dist/v12.16.3/node-v12.16.3-linux-x64.tar.gz"],
)
